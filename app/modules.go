...
import (
	...
	regulatorymodule "github.com/irisnet/irishub/modules/regulatory"
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		regulatorymodule.AppModuleBasic{},
	)
...
func appModules(
	...
	return []module.AppModule{
		...
		regulatorymodule.NewAppModule(appCodec, app.RegulatoryKeeper, app.AccountKeeper, app.BankKeeper),
	}
}
...
func orderBeginBlockers() []string {
	return []string{
		...
		regulatorymoduletypes.ModuleName,
	}
}
