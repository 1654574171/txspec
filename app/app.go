...
import (
	...
	"github.com/irisnet/irishub/modules/regulatory"
	regulatorymodulekeeper "github.com/irisnet/irishub/modules/regulatory/keeper"
	regulatorymoduletypes "github.com/irisnet/irishub/modules/regulatory/types"
)
...
type IrisApp struct {
	*baseapp.BaseApp
	...
	RegulatoryKeeper      regulatorymodulekeeper.Keeper
	// Ethermint keepers
...
func NewIrisApp(
	...
	keys := sdk.NewKVStoreKeys(
		...
		regulatorymoduletypes.StoreKey,
	)
	...
	app.RegulatoryKeeper = *regulatorymodulekeeper.NewKeeper(
		appCodec,
		keys[regulatorymoduletypes.StoreKey],
		keys[regulatorymoduletypes.MemStoreKey],
		app.GetSubspace(regulatorymoduletypes.ModuleName),
	)
	...
	govRouter.AddRoute(govtypes.RouterKey, govv1beta1.ProposalHandler).
		...
		AddRoute(regulatorymoduletypes.RouterKey, regulatory.NewRegulatoryProposalHandler(app.RegulatoryKeeper))
	...
	postHandler, _ := regulatorymodulekeeper.NewRegulatoryPostHandler(
		regulatorymodulekeeper.HandlerOptions{
			RegulatoryKeeper: app.RegulatoryKeeper,
		},
	)
...
func initParamsKeeper(
	...
	paramsKeeper.Subspace(regulatorymoduletypes.ModuleName)
