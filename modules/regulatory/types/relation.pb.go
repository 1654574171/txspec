...
// source: regulatory/regulatory/relation.proto
...
type Relation struct {
	...
	BindingName     string `protobuf:"bytes,2,opt,name=bindingName,proto3" json:"bindingName,omitempty"`
}
...
func (*Relation) Descriptor() ([]byte, []int) {
	return fileDescriptor_43f57c0604a3511d, []int{0}
}
...
func (m *Relation) GetContractAddress() string {
	if m != nil {
...
func (m *Relation) GetBindingName() string {
	if m != nil {
...
func init() {
	proto.RegisterType((*Relation)(nil), "regulatory.regulatory.Relation")
}

func init() {
	proto.RegisterFile("regulatory/regulatory/relation.proto", fileDescriptor_43f57c0604a3511d)
}

var fileDescriptor_43f57c0604a3511d = []byte{
	// 159 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Relation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BindingName) > 0 {
		...
		i = encodeVarintRelation(dAtA, i, uint64(len(m.BindingName)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ContractAddress) > 0 {
		...
		i = encodeVarintRelation(dAtA, i, uint64(len(m.ContractAddress)))
		i--
		dAtA[i] = 0xa
	}
