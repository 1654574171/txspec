...
```shell
echo yes | sudo apt-get install mysql-server mysql-client libmysqlclient-dev
sudo systemctl start mysql
sudo mysql << EOF
ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'oxhainan';
FLUSH PRIVILEGES;
exit
EOF
user="root"
pw="oxhainan" # or your passport set before
...
#### Antlr4
If you want to modify or reconstruct the binding language or rule language, pls make sure that your version of antlr4 should be *4.9.3*
