...
RequestContext::RequestContext(const string &req_id, const string &rule_text,
    ...
    this->rule_id_list_ = rule_id_list;
    split();
}
...
const vector<string> &RequestContext::get_rule_id_list() const {
    return this->rule_id_list_;
}
...
bool RequestContext::get_rule_evaluation_result(const string &rule_id) {
    // false if rule evaluation result not known
    return this->rule_evaluation_result_map_[rule_id] ? true : false;
}

// bool RequestContext::get_overall_evaluation_result()
// {
//     return this->overall_evaluation_result_;
// }
