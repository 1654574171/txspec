...
grpc::Status RegisterServiceImpl::RegisterRegulatoryService(::grpc::ServerContext* context, 
    ...
    KEYMANAGEMENT_ERROR_CODE error_code = StartRemoteAttestationCosmos(response);
...
KEYMANAGEMENT_ERROR_CODE RegisterServiceImpl::StartRemoteAttestationCosmos(request_proto::RegisterResponse *const register_resp) {
