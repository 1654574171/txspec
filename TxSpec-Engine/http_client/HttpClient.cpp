...
std::string HttpClient::generateQueryTarget(const char* subgraph) {
...
json11::Json HttpClient::query(const char* querySentence,
                               const char* subgraph) {
    try {
        // prepare connection
        ...
        SPDLOG_INFO("Query Target is {}", queryTarget);
